...
public class BaseTest {
    ...
    public RaiseATicketPage raiseaticketpage;
    ...
    public void ConfigureAppium() throws MalformedURLException {
        ...
        options.setDeviceName("OPPO A9 2020");
        options.setApp("C://Users//hp//Downloads//Paycio-release (1).apk"); // Path to your APK
...
//        // Initialize the Android Driver with the options
    ...
    public static void closeNativeKeyboard() {
        try {
            driver.hideKeyboard();
        } catch (Exception e) {
